...
#define DEST_MAC3 0x9B
#define DEST_MAC4 0x08
#define DEST_MAC5 0x90
...
int main()
{
  ...
  //char msg[] = "Hello, this is a test message.hitymd";
  ...
  iph->check = 0;
  iph->saddr = inet_addr("192.168.102.130");//源主机
  iph->daddr = inet_addr("192.168.102.131");//目的主机
